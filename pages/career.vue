<template>
  <div class="post">
    ...
    <div class="entry">
      ...
      <experience>
        <template #period>Aug 2015, Present</template>
        <template #job-title>Research and Development Engineer</template>
        <template #partner>Cohorte Technologies</template>
        <template #description>Development of the company's flagship artefact, Cohorte Runtime, as well as taking into responsibilities          different other projects in collaboration with Agilium, such as Agilium GED-Engine.</template>
      </experience>
      <experience>
        ...
        <template #description>Teaching included lectures and course materials preparation, tutoring and evaluation, besides regular            research            responsibilities.</template>
      </experience>
      <experience>
        <template #period>Oct 2010, Aug 2013</template>
        <template #job-title>PhD Candidate</template>
        <template #partner>G-SCOP Laboratory, Grenoble INP</template>
        <template #description>This work took place in participation to a collaborative national effort in the frame of ROMMA project.<br/> The project as such aimed to automate the process of preparation of the digital mock-up; that is the geometric representation of a product, in order to meet simulation process requirements. In the context of my research, a method to automatically identify components functional properties, and to restructure their geometry according to this functional knowledge, was proposed and implemented. This implementation provided semantic annotations that are necessary for the finite-element-analysis preparation phase. The method validity was against real-life data provided by industrial partner.</template>
      </experience>
      <experience>
        ...
        <template #description>As ITS' envoy to Real-Estate Bank of Syria, I have learned how to insure important responsibilities, work          under          pressure, be in direct contact with customer, react fast, and make quick and sane decisions. Working from customer's premises, I supported one of ITS' major products; Phoenix, the core banking system, where all day-to-day banking transactions are processed. Working with ITS has reinforced many values, among which commitment, creativity, cooperation and productivity.</template>
      </experience>
      <experience>
      ...
      <experience>
        ...
        <template #description>Working at the Department of Business and Information Technology Solutions (BITS), I built a web-based          Content          Management System, customizable in a way that complies with requirements of the variant customers. I also          developed an integrated search engine. The job required keeping up to date with cutting edge web          technologies of          the time, to find efficient solutions for the ever growing Internet users’ needs.</template>
      </experience>
